    ...
    <Box mt={24} mx={{ base: 6, md: "5%" }}>
      ...
      >
        <Box display={{ base: "block", sm: "none" }}>
          <Text mb={4} fontSize="3xl" color="#1CA5AE">
            Contact us
          </Text>
        ...
        <Box style={{ height: "auto" }}>
          <Image
            ...
            height={400} // Set a fixed height (adjust as needed)
          />
        </Box>
        <Spacer />
        ...
        <Box maxW="45rem" ml={4}>
          ...
          <Text mt={8} align={"center"}>
            ...
            selling or renting your first home? Need a consultation on
            residential issues? Just contact us. We are readily available 24/7.
          </Text>
