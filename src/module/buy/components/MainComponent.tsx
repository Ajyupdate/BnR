...
export default function MainComponentAction({
  title,
  location,
  price,
  image,
  ...
  return (
    <Box onClick={() => console.log(router.push("./buy/1"))}>
      <Stack
        p="4"
        border="1px"
      ...
      >
        ...
        <Text color="#1CA5AE" fontSize={"2xl"} fontWeight={600}>
          ${price}K
        </Text>
      ...
      <Center color={"#03373A"}>
        <Text display={{ base: "block", md: "none" }} my={4} fontWeight="bold">
          Text Details
        </Text>
      </Center>
    </Box>
