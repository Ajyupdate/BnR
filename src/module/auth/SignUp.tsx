...
export default function SignUpForm() {
  ...
  const validationSchema = Yup.object({
    first_name: Yup.string()
      .max(15, "must not exceed 15 character")
    ...
    phone_number: Yup.number()
      .min(11, "must not be less than 11")
      .required("Phone numeber is required"),
            ...
            <Center mb={4}>
              <Flex justify={"space-between"} gap={2} mx={8}>
                ...
                <Text mt={{ base: 4, md: "unset" }}>
                  I would like to receive updates, tips and exciting offers from
                  RealEstatery
                </Text>
              </Flex>
            </Center>
